        ...
        <div class="col-lg-12 margin-tb">
            <div class="card">
                <div class="card-body d-flex justify-content-end">
                    {{-- @can('brand-create') --}}
                    <button class="btn btn-success" onclick="create()">Tambah Cabang</button>
                    {{-- @endcan --}}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Create New Cabang</h5>
                ...
                <div class="modal-body">
                    ...
                    <form id="form-update-cabang" action="javascript:void(0)" accept-charset="utf-8" enctype="multipart/form-data">
                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="mb-3">
                                <label class="form-label">Nama Cabang</label>
                                <input type="text" class="form-control" name="cabang" id="cabang_update"
...
@section('script')
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: (data) => {
                    if ($.isEmptyObject(data.error)) {
                        ...
                        window.location.href = "{{ url('admin/cabang') }}";
                    } else {
                        Swal.fire({
                            icon: 'error',
        ...
        function update(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#cabang_update').val(response.data.cabang);
                    //open modal
        ...
        $('#form-update-cabang').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('admin/cabang/update') }}/" + id,
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
        ...
        function destroyArea(id) {
            Swal.fire({
                ...
                if (e.value === true) {
                    $.ajax({
                        type: "get",
                        url: "{{ url('admin/cabang/destroy') }}/" + id,
