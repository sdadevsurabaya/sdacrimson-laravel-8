    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="card">
                <div class="card-body">
                    {{-- @can('brand-create') --}}
                    <button class="btn btn-success" onclick="create()"> Buat Area Baru</button>
                    {{-- @endcan --}}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="create_area" method="POST" action="javascript:void(0)"
                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    name="area"
                                    id="area" placeholder="Contoh: Jatim 1">
                            </div>
                        </div>
                        <div class="col-xl-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    name="nama_area"
                                    id="nama_area" placeholder="Contoh: Surabaya">
                            </div>
                        </div>
                        <div class="col-xl-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    name="detarea"
                                    id="detarea" placeholder="Contoh: Surabaya, Sidoarjo, Gresik ">
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="update_area" method="POST" action="javascript:void(0)"
                        accept-charset="utf-8" enctype="multipart/form-data">
                        {{-- {!! csrf_field() !!} --}}
                        @csrf
                        @php
                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    name="area_update"
                                    id="area_update" placeholder="Contoh: Jatim 1">
                            </div>
                        </div>
                        <div class="col-xl-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    name="nmarea_update"
                                    id="nmarea_update" placeholder="Contoh: Surabaya">
                            </div>
                        </div>
                        <div class="col-xl-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    name="detarea_update"
                                    id="detarea_update" placeholder="Contoh: Surabaya, Gresik">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success"
            ...
            $.ajax({
                ...
                success: (data) => {
                    if ($.isEmptyObject(data.error)) {
                        ...
                        window.location.href = "{{url('admin/area')}}";
                    } else {
                        Swal.fire({
                            icon: 'error',
        ...
        function update(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#area_update').val(response.data.area);
                    $('#nmarea_update').val(response.data.nama_area);
                    $('#detarea_update').val(response.data.detail);
                    //open modal
