...
@section('content')
                                ...
                                <form id="create_general" method="POST" action="javascript:void(0)" accept-charset="utf-8"
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <input type="hidden" class="form-control" name="created_date" id="created_date"
                                            value="{{ date('Y-m-d') }}">
                                        <input type="hidden" class="form-control" name="ar" id="ar"
                                            value="{{ Str::ucfirst(Auth::user()->id) }}">

                                        <div class="row">
                                            <label class="form-label col-md-2" for="formrow-Fullname-input"><span
                                                    style="color: crimson;">*</span> Usaha</label>
                                            <div class="mb-3 col-md-10">
                                                <select
                                                    class="form-select @error('type_usaha') border border-danger @enderror"
                                                    name="type_usaha" id="floatingSelectGrid type_usaha"
                                                    aria-label="Floating label select example">
                                                    <option value="">-- Pilih Type Usaha --</option>
                                                    <option value="TK"
                                                        @if (old('type_usaha') == 'TK') selected="selected" @endif>
                                                        Toko</option>
                                                    <option value="UD"
                                                        @if (old('type_usaha') == 'UD') selected="selected" @endif>UD
                                                    </option>
                                                    <option value="CV"
                                                        @if (old('type_usaha') == 'CV') selected="selected" @endif>CV
                                                    </option>
                                                    <option value="PT"
                                                        @if (old('type_usaha') == 'PT') selected="selected" @endif>PT
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="nama_usaha"><span
                                                style="color: crimson;">*</span> Nama Usaha</label>
                                        <div class="mb-3 col-md-10">
                                            <input type="text"
                                                class="form-control @error('nama_usaha') border border-danger @enderror"
                                                name="nama_usaha" id="nama_usaha"
                                                value="{{ old('nama_usaha') }}"style="text-transform:uppercase;">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="alamat_kantor"><span
                                                style="color: crimson;">*</span> Alamat Kantor</label>
                                        <div class="mb-3 col-md-10">
                                            <input type="text"
                                    ...
                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="nama_lengkap"><span
                                                style="color: crimson;">*</span> Nama Lengkap</label>
                                        <div class="mb-3 col-md-10">
                                            <input type="text"
                                    ...
                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="formrow-email-input"><span
                                                style="color: crimson;">*</span> Jabatan</label>
                                        <div class="mb-3 col-md-10">
                                            ...
                                            <input type="text" class="form-control" name="jabatan" id="jabatan"
                                                value="Pemilik" readonly>

                                        </div>
                                    </div>

                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="mobile_phone"><span
                                                style="color: crimson;">*</span> Mobile</label>
                                        <div class="mb-3 col-md-10">
                                            <input type="Number"
                                                class="form-control @error('mobile_phone') border border-danger @enderror"
                                                name="mobile_phone" id="mobile_phone" value="{{ old('mobile_phone') }}">
                                        </div>
                                    </div>

                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="area"><span
                                                style="color: crimson;">*</span>Area</label>
                                        <div class="mb-3 col-md-10">
                                            <input type="text"
                                                class="form-control @error('area') border border-danger @enderror"
                                                name="area" id="area"
                                                value="{{ old('area') }}"style="text-transform:uppercase;">
                                        </div>
                                    </div>

                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="kota"><span
                                                style="color: crimson;">*</span>Kota</label>
                                        <div class="mb-3 col-md-10">
                                            <input type="text"
                                                class="form-control @error('kota') border border-danger @enderror"
                                                name="kota" id="kota"
                                                value="{{ old('kota') }}"style="text-transform:uppercase;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="telepon">Telepon</label>
                                        <div class="mb-3 col-md-10">
                                            <input type="number"
                                                class="form-control @error('telepon') border border-danger @enderror"
                                    ...
                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="web_site">Website</label>
                                        <div class="mb-3 col-md-10">
                                            <input type="text"
                                                class="form-control @error('web_site') border border-danger @enderror"
                                                name="web_site" id="web_site" value="{{ old('web_site') }}">
                                        </div>
                                    </div>

                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="formrow-password-input">NO
                                            NPWP</label>
                                        <div class="mb-3 col-md-10">
                                            <input type="Number"
                                                class="form-control @error('no_npwp') border border-danger @enderror"
                                                name="no_npwp" id="no_npwp" value="{{ old('no_npwp') }}">
                                        </div>
                                    </div>

                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="nama_npwp">Nama NPWP</label>
                                        <div class="mb-3 col-md-10">
                                            <input type="text"
                                                class="form-control @error('nama_npwp') border border-danger @enderror"
                                                name="nama_npwp" id="nama_npwp" value="{{ old('nama_npwp') }}">
                                        </div>
                                    </div>

                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="alamat_npwp">Alamat NPWP</label>
                                        <div class="mb-3 col-md-10">
                                            <input type="text"
                                                class="form-control @error('alamat_npwp') border border-danger @enderror"
                                                name="alamat_npwp" id="alamat_npwp" value="{{ old('alamat_npwp') }}">
                                        </div>
                                    </div>

                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="nik">NIK</label>
                                        <div class="mb-3 col-md-10">
                                            <input type="number"
                                                class="form-control @error('nik') border border-danger @enderror"
                                                name="nik" id="nik" value="{{ old('nik') }}">
                                        </div>
                                    </div>

                                    <div class="mb-3 row">
                                        <label class="form-label col-md-2" for="formrow-password-input">Account
                                            Representative</label>
                                        <div class="mb-3 col-md-10">
                                            <input type="hidden" class="form-control" name="id_general" id="id_general"
                                                value="{{ $id }}">
                                            <input type="text" class="form-control" name="" id=""
                                                value="{{ Str::ucfirst(Auth::user()->name) }}" disabled>
                                        </div>
                                    </div>

                                    <div style="color:crimson;">* Wajib diisi</div>
                                    <div class="col-xs-12 col-sm-12 text-center selanjutnya">
                                    ...
                                    <div class="col-xs-12 col-sm-12 text-center loading">
    ...
    <div class="modal fade" id="ModalTempatMenyimpan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3 row">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select tempat" name="tempat" id="floatingSelectGrid"
                                aria-label="Floating label select example">
                            ...
                            success: (data) => {
                                if ($.isEmptyObject(data.error)) {
                                    ...
                                    window.location.href =
                                        "{{ url('admin/generals/berkas') }}/" + data.success;
                                } else {
                                    Swal.fire({
                                        icon: 'error',
                                    ...
                                    document.getElementsByClassName('selanjutnya')[0].style
                                        .display = "block";
                        ...
                        $.ajax({
                            ...
                            success: (data) => {
                                ...
                                if (localStorage.getItem('daftar_general') === null) {
                                    ...
                                    daftar_general = JSON.parse(localStorage.getItem(
                                        'daftar_general'));
                                }

                                daftar_general.push(myGeneral);
                                localStorage.setItem('daftar_general', JSON.stringify(
                                    daftar_general));

                                window.location.href = "{{ url('admin/generals/berkas') }}/" +
                                    data.success;
                            }
                        });
