    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="card">
                <div class="card-body">
                    {{-- @can('brand-create') --}}
                    <button class="btn btn-success" onclick="create()"> Buat Brand Baru</button>
                    {{-- @endcan --}}
                                ...
                                @foreach ($get_Brand as $key => $data)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-medium btn-danger" onclick="destroyBrand({{ $data->id }})">Hapus</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    name="brand"
                                    id="brand" placeholder="Contoh: Rasa Sayang">
                            </div>
                        </div>
                    ...
                    <form id="update_brand" method="POST" action="javascript:void(0)"
                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    name="brand_update"
                                    id="brand_update" placeholder="Contoh: Rasa Sayang">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success"
        ...
        function update(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#brand_update').val(response.data.brand);
                    //open modal
