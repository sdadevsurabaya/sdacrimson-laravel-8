...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/back/monthlyreport', [\App\Http\Controllers\Back\MonthlyReportController::class, 'index'])->name('back.monthlyreport.index');
    Route::get('/back/monthlyreport/excel', [\App\Http\Controllers\Back\MonthlyReportController::class, 'exportExcel'])->name('back.monthlyreport.excel');
    Route::get('/back/monthlyreport/pdf', [\App\Http\Controllers\Back\MonthlyReportController::class, 'exportPdf'])->name('back.monthlyreport.pdf');
    Route::get('/back/monthlyreport/stats', [\App\Http\Controllers\Back\MonthlyReportController::class, 'getMonthlyStats'])->name('back.monthlyreport.stats');
