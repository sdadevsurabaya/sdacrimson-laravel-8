...
class GeneralController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (Auth::user()->hasRole("Admin") == 1 || Auth::user()->hasRole("Verifikator") == 1 || Auth::user()->hasRole("Toko") == 1 || Auth::user()->hasRole("Manager Sales") == 1 || Auth::user()->hasRole("Head Of Sales") == 1) {
